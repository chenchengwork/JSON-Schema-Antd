...
/**
 * 获取默认注册表
 * @returns {{fields: ({ArrayField, BooleanField, DescriptionField, NumberField, ObjectField, SchemaField, StringField, TitleField, UnsupportedField}|*), widgets: ({BaseInput, PasswordWidget, RadioWidget, UpDownWidget, RangeWidget, SelectWidget, TextWidget, DateWidget, DateTimeWidget, AltDateWidget, AltDateTimeWidget, EmailWidget, URLWidget, TextareaWidget, HiddenWidget, ColorWidget, FileWidget, CheckboxWidget, CheckboxesWidget}|*), definitions: {}, formContext: {}}}
 */
...
export function isFixedItems(schema) {
    return (
        ...
        schema.items.every(item => isObject(item))  // every验证数组中每个元素都符合回调函数
    );
}
